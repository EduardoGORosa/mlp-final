...
/* package mlp-final-0.1.0.0 */
#ifndef VERSION_mlp_final
#define VERSION_mlp_final "0.1.0.0"
#endif /* VERSION_mlp_final */
#ifndef MIN_VERSION_mlp_final
#define MIN_VERSION_mlp_final(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mlp_final */
...
#define CURRENT_COMPONENT_ID "mlp-final-0.1.0.0-inplace-mlp-final"
